...
- Query - [top-js-repos.graphql](./src/top-js-repos.graphql)
- Client usage - [github.js](./src/github.js)

Generated at Sat, 22 Aug 2020 07:31:12 GMT

| Name | URL | Description | Stars | 
|-|-|-|-| 
| freeCodeCamp | https://github.com/freeCodeCamp/freeCodeCamp | freeCodeCamp.org's open source codebase and curriculum. Learn to code at home. | 313834 | 
| vue | https://github.com/vuejs/vue | 🖖 Vue.js is a progressive, incrementally-adoptable JavaScript framework for building UI on the web. | 170462 | 
| javascript | https://github.com/airbnb/javascript | JavaScript Style Guide | 99025 | 
| react-native | https://github.com/facebook/react-native | A framework for building native apps with React. | 89586 | 
| axios | https://github.com/axios/axios | Promise based HTTP client for the browser and node.js | 76261 | 
| node | https://github.com/nodejs/node | Node.js JavaScript runtime :sparkles::turtle::rocket::sparkles: | 72474 | 
| three.js | https://github.com/mrdoob/three.js | JavaScript 3D library. | 62879 | 
| 30-seconds-of-code | https://github.com/30-seconds/30-seconds-of-code | Short JavaScript code snippets for all your development needs | 58953 | 
| webpack | https://github.com/webpack/webpack | A bundler for javascript and friends. Packs many modules into a few bundled assets. Code Splitting allows for loading parts of the application on demand. Through "loaders", modules can be CommonJs, AMD, ES6 modules, CSS, Images, JSON, Coffeescript, LESS, ... and your custom stuff. | 55346 | 
| next.js | https://github.com/vercel/next.js | The React Framework | 52191 | 
| socket.io | https://github.com/socketio/socket.io | Realtime application framework (Node.JS server) | 50490 | 
| nodebestpractices | https://github.com/goldbergyoni/nodebestpractices | :white_check_mark:  The Node.js best practices list (August 2020) | 50411 | 
| Chart.js | https://github.com/chartjs/Chart.js | Simple HTML5 Charts using the <canvas> tag | 50028 | 
| Semantic-UI | https://github.com/Semantic-Org/Semantic-UI | Semantic is a UI component framework based around useful principles from natural language. | 48354 | 
| realworld | https://github.com/gothinkster/realworld | "The mother of all demo apps" — Exemplary fullstack Medium.com clone powered by React, Angular, Node, Django, and many more 🏅 | 45748 | 
| resume.github.com | https://github.com/resume/resume.github.com | Resumes generated using the GitHub informations | 45710 | 
| tech-interview-handbook | https://github.com/yangshun/tech-interview-handbook | 💯 Materials to help you rock your next coding interview | 44384 | 
| react-router | https://github.com/ReactTraining/react-router | Declarative routing for React | 41473 | 
| hacker-scripts | https://github.com/NARKOZ/hacker-scripts | Based on a true story | 39224 | 
| awesome-mac | https://github.com/jaywcjlove/awesome-mac |  Now we have become very big, Different from the original idea. Collect premium software in various categories. | 38835 | 
| materialize | https://github.com/Dogfalo/materialize | Materialize, a CSS Framework based on Material Design | 37929 | 
| prettier | https://github.com/prettier/prettier | Prettier is an opinionated code formatter. | 37452 | 
| babel | https://github.com/babel/babel | 🐠 Babel is a compiler for writing next generation JavaScript. | 37260 | 
| svelte | https://github.com/sveltejs/svelte | Cybernetically enhanced web apps | 36385 | 
| impress.js | https://github.com/impress/impress.js | It's a presentation framework based on the power of CSS3 transforms and transitions in modern browsers and inspired by the idea behind prezi.com. | 35839 | 
| leetcode | https://github.com/azl397985856/leetcode |  LeetCode Solutions: A Record of My Problem Solving Journey.( leetcode题解，记录自己的leetcode解题之路。) | 35615 | 
| brackets | https://github.com/adobe/brackets | An open source code editor for the web, written in JavaScript, HTML and CSS. | 31744 | 
| algorithm-visualizer | https://github.com/algorithm-visualizer/algorithm-visualizer | :fireworks:Interactive Online Platform that Visualizes Algorithms from Code | 31415 | 
...
| pug | https://github.com/pugjs/pug | Pug – robust, elegant, feature rich template engine for Node.js | 19486 | 
